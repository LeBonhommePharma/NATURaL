# NATURaL — Unfolding Light

Approved icon direction: a luminous bloom opening around a warm sun. The shared silhouette suggests breath, movement and renewal. Plum anchors the jewel palette; turquoise/jade, violet and coral bring energy without using medical symbols or text.

The Watch composition is more compact for the circular system mask. Both exported assets are 1024 × 1024, opaque RGB PNG. Apple applies the final device masks; corners are not baked into the assets. `Bloom.imageset` makes the same artwork available inside the app.
...
## Watch refinement prompt

Create watchOS companion version of this NATURaL icon. Preserve exactly the identity, jewel palette and luminous unfurling human/bloom concept: golden orb, two violet inner petals, jade/turquoise outer petals, coral cupped base. Simplify and thicken forms slightly for tiny watch display. Scale down the entire bloom to occupy only central 68% of image width and height, with generous uniform deep midnight plum edge-to-edge background, ensuring all petal tips fully fit inside the centered inscribed circular mask with an additional 8% margin. Fully opaque square 1024x1024 final asset. No pre-drawn circle, no rounded corners, no text, no watch hardware or mockup. One finished icon.
