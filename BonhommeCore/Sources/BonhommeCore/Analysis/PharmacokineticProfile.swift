...
extension PharmacokineticProfile {
    ...
    public static let amphetamine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Amphetamine", fr: "Amphétamine", es: "Anfetamina", ja: "アンフェタミン", zh: "苯丙胺", ko: "암페타민", ru: "Амфетамин", de: "Amphetamin", ar: "أمفيتامين"),
    ...
    public static let lisdexamfetamine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Lisdexamfetamine", fr: "Lisdexamfétamine", es: "Lisdexanfetamina", ja: "リスデキサンフェタミン", zh: "赖右苯丙胺", ko: "리스덱스암페타민", ru: "Лиздексамфетамин", de: "Lisdexamfetamin", ar: "ليسديكسامفيتامين"),
        therapeuticClass: .stimulant,
        onsetMinutes: 60,
        tmaxMinutes: 210,
        halfLifeMinutes: 720,
    ...
    public static let methylphenidate = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Methylphenidate", fr: "Méthylphénidate", es: "Metilfenidato", ja: "メチルフェニデート", zh: "哌甲酯", ko: "메틸페니데이트", ru: "Метилфенидат", de: "Methylphenidat", ar: "ميثيلفينيدات"),
        therapeuticClass: .stimulant,
        onsetMinutes: 20,
        tmaxMinutes: 120,
        halfLifeMinutes: 180,
    ...
    public static let dextroamphetamine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Dextroamphetamine", fr: "Dextroamphétamine", es: "Dextroanfetamina", ja: "デキストロアンフェタミン", zh: "右旋苯丙胺", ko: "덱스트로암페타민", ru: "Декстроамфетамин", de: "Dextroamphetamin", ar: "ديكستروأمفيتامين"),
        therapeuticClass: .stimulant,
        onsetMinutes: 30,
        tmaxMinutes: 180,
        halfLifeMinutes: 720,
    ...
    public static let methamphetamine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Methamphetamine", fr: "Méthamphétamine", es: "Metanfetamina", ja: "メタンフェタミン", zh: "甲基苯丙胺", ko: "메스암페타민", ru: "Метамфетамин", de: "Methamphetamin", ar: "ميثامفيتامين"),
        therapeuticClass: .stimulant,
        onsetMinutes: 20,
        tmaxMinutes: 180,
        halfLifeMinutes: 600,
    ...
    public static let modafinil = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Modafinil", fr: "Modafinil", es: "Modafinilo", ja: "モダフィニル", zh: "莫达非尼", ko: "모다피닐", ru: "Модафинил", de: "Modafinil", ar: "مودافينيل"),
        therapeuticClass: .stimulant,
        onsetMinutes: 60,
        tmaxMinutes: 180,
        halfLifeMinutes: 900,
    ...
    public static let armodafinil = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Armodafinil", fr: "Armodafinil", es: "Armodafinilo", ja: "アルモダフィニル", zh: "阿莫达非尼", ko: "아르모다피닐", ru: "Армодафинил", de: "Armodafinil", ar: "أرمودافينيل"),
        therapeuticClass: .stimulant,
        onsetMinutes: 60,
        tmaxMinutes: 120,
        halfLifeMinutes: 900,
    ...
    public static let atomoxetine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Atomoxetine", fr: "Atomoxétine", es: "Atomoxetina", ja: "アトモキセチン", zh: "托莫西汀", ko: "아토목세틴", ru: "Атомоксетин", de: "Atomoxetin", ar: "أتوموكسيتين"),
        therapeuticClass: .stimulant,
        onsetMinutes: 60,
        tmaxMinutes: 90,
        halfLifeMinutes: 300,
...
extension PharmacokineticProfile {
    ...
    public static let caffeine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Caffeine", fr: "Caféine", es: "Cafeína", ja: "カフェイン", zh: "咖啡因", ko: "카페인", ru: "Кофеин", de: "Coffein", ar: "كافيين"),
        therapeuticClass: .stimulant,
        onsetMinutes: 15,
        tmaxMinutes: 45,
        halfLifeMinutes: 300,
    ...
    public static let theophylline = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Theophylline", fr: "Théophylline", es: "Teofilina", ja: "テオフィリン", zh: "茶碱", ko: "테오필린", ru: "Теофиллин", de: "Theophyllin", ar: "ثيوفيلين"),
...
extension PharmacokineticProfile {
    ...
    public static let propranolol = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Propranolol", fr: "Propranolol", es: "Propranolol", ja: "プロプラノロール", zh: "普萘洛尔", ko: "프로프라놀롤", ru: "Пропранолол", de: "Propranolol", ar: "بروبرانولول"),
    ...
    public static let metoprolol = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Metoprolol", fr: "Métoprolol", es: "Metoprolol", ja: "メトプロロール", zh: "美托洛尔", ko: "메토프롤롤", ru: "Метопролол", de: "Metoprolol", ar: "ميتوبرولول"),
        therapeuticClass: .betaBlocker,
        onsetMinutes: 30,
        tmaxMinutes: 90,
        halfLifeMinutes: 300,
    ...
    public static let atenolol = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Atenolol", fr: "Aténolol", es: "Atenolol", ja: "アテノロール", zh: "阿替洛尔", ko: "아테놀롤", ru: "Атенолол", de: "Atenolol", ar: "أتينولول"),
        therapeuticClass: .betaBlocker,
        onsetMinutes: 60,
        tmaxMinutes: 180,
        halfLifeMinutes: 390,
    ...
    public static let bisoprolol = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Bisoprolol", fr: "Bisoprolol", es: "Bisoprolol", ja: "ビソプロロール", zh: "比索洛尔", ko: "비소프롤롤", ru: "Бисопролол", de: "Bisoprolol", ar: "بيسوبرولول"),
        therapeuticClass: .betaBlocker,
        onsetMinutes: 60,
        tmaxMinutes: 150,
        halfLifeMinutes: 660,
    ...
    public static let carvedilol = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Carvedilol", fr: "Carvédilol", es: "Carvedilol", ja: "カルベジロール", zh: "卡维地洛", ko: "카르베딜롤", ru: "Карведилол", de: "Carvedilol", ar: "كارفيديلول"),
        therapeuticClass: .betaBlocker,
        onsetMinutes: 30,
        tmaxMinutes: 90,
        halfLifeMinutes: 510,
    ...
    public static let clonidine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Clonidine", fr: "Clonidine", es: "Clonidina", ja: "クロニジン", zh: "可乐定", ko: "클로니딘", ru: "Клонидин", de: "Clonidin", ar: "كلونيدين"),
    ...
    public static let guanfacine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Guanfacine", fr: "Guanfacine", es: "Guanfacina", ja: "グアンファシン", zh: "胍法辛", ko: "구안파신", ru: "Гуанфацин", de: "Guanfacin", ar: "غوانفاسين"),
        therapeuticClass: .alphaAgonist,
        onsetMinutes: 60,
        tmaxMinutes: 240,
    ...
    public static let digoxin = PharmacokineticProfile(
        substanceId: "digoxin",
        name: LocalizedString(en: "Digoxin", fr: "Digoxine", es: "Digoxina", ja: "ジゴキシン", zh: "地高辛", ko: "디곡신", ru: "Дигоксин", de: "Digoxin", ar: "ديجوكسين"),
    ...
    public static let ivabradine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Ivabradine", fr: "Ivabradine", es: "Ivabradina", ja: "イバブラジン", zh: "伊伐布雷定", ko: "이바브라딘", ru: "Ивабрадин", de: "Ivabradin", ar: "إيفابرادين"),
        therapeuticClass: .cardiovascular,
        onsetMinutes: 30,
        tmaxMinutes: 60,
        halfLifeMinutes: 360,
...
extension PharmacokineticProfile {
    ...
    public static let sertraline = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Sertraline", fr: "Sertraline", es: "Sertralina", ja: "セルトラリン", zh: "舍曲林", ko: "세르트랄린", ru: "Сертралин", de: "Sertralin", ar: "سيرترالين"),
    ...
    public static let fluoxetine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Fluoxetine", fr: "Fluoxétine", es: "Fluoxetina", ja: "フルオキセチン", zh: "氟西汀", ko: "플루옥세틴", ru: "Флуоксетин", de: "Fluoxetin", ar: "فلوكسيتين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 120,
        tmaxMinutes: 420,
    ...
    public static let escitalopram = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Escitalopram", fr: "Escitalopram", es: "Escitalopram", ja: "エスシタロプラム", zh: "艾司西酞普兰", ko: "에스시탈로프람", ru: "Эсциталопрам", de: "Escitalopram", ar: "إسيتالوبرام"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 120,
        tmaxMinutes: 300,
    ...
    public static let paroxetine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Paroxetine", fr: "Paroxétine", es: "Paroxetina", ja: "パロキセチン", zh: "帕罗西汀", ko: "파록세틴", ru: "Пароксетин", de: "Paroxetin", ar: "باروكسيتين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 120,
        tmaxMinutes: 300,
    ...
    public static let venlafaxine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Venlafaxine", fr: "Venlafaxine", es: "Venlafaxina", ja: "ベンラファキシン", zh: "文拉法辛", ko: "벤라팍신", ru: "Венлафаксин", de: "Venlafaxin", ar: "فينلافاكسين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 60,
        tmaxMinutes: 120,
        halfLifeMinutes: 300,
    ...
    public static let duloxetine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Duloxetine", fr: "Duloxétine", es: "Duloxetina", ja: "デュロキセチン", zh: "度洛西汀", ko: "둘록세틴", ru: "Дулоксетин", de: "Duloxetin", ar: "دولوكسيتين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 120,
        tmaxMinutes: 360,
        halfLifeMinutes: 720,
    ...
    public static let bupropion = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Bupropion", fr: "Bupropion", es: "Bupropión", ja: "ブプロピオン", zh: "安非他酮", ko: "부프로피온", ru: "Бупропион", de: "Bupropion", ar: "بوبروبيون"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 60,
        tmaxMinutes: 120,
        halfLifeMinutes: 1260,
    ...
    public static let mirtazapine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Mirtazapine", fr: "Mirtazapine", es: "Mirtazapina", ja: "ミルタザピン", zh: "米氮平", ko: "미르타자핀", ru: "Миртазапин", de: "Mirtazapin", ar: "ميرتازابين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 60,
        tmaxMinutes: 120,
        halfLifeMinutes: 1800,
    ...
    public static let trazodone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Trazodone", fr: "Trazodone", es: "Trazodona", ja: "トラゾドン", zh: "曲唑酮", ko: "트라조돈", ru: "Тразодон", de: "Trazodon", ar: "ترازودون"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 30,
        tmaxMinutes: 60,
        halfLifeMinutes: 420,
    ...
    public static let amitriptyline = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Amitriptyline", fr: "Amitriptyline", es: "Amitriptilina", ja: "アミトリプチリン", zh: "阿米替林", ko: "아미트리프틸린", ru: "Амитриптилин", de: "Amitriptylin", ar: "أميتريبتيلين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 60,
        tmaxMinutes: 240,
    ...
    public static let nortriptyline = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Nortriptyline", fr: "Nortriptyline", es: "Nortriptilina", ja: "ノルトリプチリン", zh: "去甲替林", ko: "노르트리프틸린", ru: "Нортриптилин", de: "Nortriptylin", ar: "نورتريبتيلين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 60,
        tmaxMinutes: 300,
    ...
    public static let phenelzine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Phenelzine", fr: "Phénelzine", es: "Fenelzina", ja: "フェネルジン", zh: "苯乙肼", ko: "페넬진", ru: "Фенелзин", de: "Phenelzin", ar: "فينيلزين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 60,
        tmaxMinutes: 120,
        halfLifeMinutes: 720,
    ...
    public static let tranylcypromine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Tranylcypromine", fr: "Tranylcypromine", es: "Tranilcipromina", ja: "トラニルシプロミン", zh: "反苯环丙胺", ko: "트라닐시프로민", ru: "Транилципромин", de: "Tranylcypromin", ar: "ترانيلسيبرومين"),
        therapeuticClass: .antidepressant,
        onsetMinutes: 30,
        tmaxMinutes: 90,
        halfLifeMinutes: 150,
...
extension PharmacokineticProfile {
    ...
    public static let quetiapine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Quetiapine", fr: "Quétiapine", es: "Quetiapina", ja: "クエチアピン", zh: "喹硫平", ko: "쿠에티아핀", ru: "Кветиапин", de: "Quetiapin", ar: "كويتيابين"),
    ...
    public static let olanzapine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Olanzapine", fr: "Olanzapine", es: "Olanzapina", ja: "オランザピン", zh: "奥氮平", ko: "올란자핀", ru: "Оланзапин", de: "Olanzapin", ar: "أولانزابين"),
        therapeuticClass: .antipsychotic,
        onsetMinutes: 120,
        tmaxMinutes: 390,
        halfLifeMinutes: 1800,
    ...
    public static let risperidone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Risperidone", fr: "Rispéridone", es: "Risperidona", ja: "リスペリドン", zh: "利培酮", ko: "리스페리돈", ru: "Рисперидон", de: "Risperidon", ar: "ريسبيريدون"),
        therapeuticClass: .antipsychotic,
        onsetMinutes: 30,
        tmaxMinutes: 60,
        halfLifeMinutes: 1260,
    ...
    public static let aripiprazole = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Aripiprazole", fr: "Aripiprazole", es: "Aripiprazol", ja: "アリピプラゾール", zh: "阿立哌唑", ko: "아리피프라졸", ru: "Арипипразол", de: "Aripiprazol", ar: "أريبيبرازول"),
        therapeuticClass: .antipsychotic,
        onsetMinutes: 120,
        tmaxMinutes: 240,
    ...
    public static let haloperidol = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Haloperidol", fr: "Halopéridol", es: "Haloperidol", ja: "ハロペリドール", zh: "氟哌啶醇", ko: "할로페리돌", ru: "Галоперидол", de: "Haloperidol", ar: "هالوبيريدول"),
        therapeuticClass: .antipsychotic,
        onsetMinutes: 60,
        tmaxMinutes: 240,
    ...
    public static let chlorpromazine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Chlorpromazine", fr: "Chlorpromazine", es: "Clorpromazina", ja: "クロルプロマジン", zh: "氯丙嗪", ko: "클로르프로마진", ru: "Хлорпромазин", de: "Chlorpromazin", ar: "كلوربرومازين"),
        therapeuticClass: .antipsychotic,
        onsetMinutes: 30,
        tmaxMinutes: 180,
        halfLifeMinutes: 1800,
    ...
    public static let clozapine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Clozapine", fr: "Clozapine", es: "Clozapina", ja: "クロザピン", zh: "氯氮平", ko: "클로자핀", ru: "Клозапин", de: "Clozapin", ar: "كلوزابين"),
        therapeuticClass: .antipsychotic,
        onsetMinutes: 60,
        tmaxMinutes: 150,
        halfLifeMinutes: 720,
...
extension PharmacokineticProfile {
    ...
    public static let alprazolam = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Alprazolam", fr: "Alprazolam", es: "Alprazolam", ja: "アルプラゾラム", zh: "阿普唑仑", ko: "알프라졸람", ru: "Алпразолам", de: "Alprazolam", ar: "ألبرازولام"),
    ...
    public static let diazepam = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Diazepam", fr: "Diazépam", es: "Diazepam", ja: "ジアゼパム", zh: "地西泮", ko: "디아제팜", ru: "Диазепам", de: "Diazepam", ar: "ديازيبام"),
        therapeuticClass: .anxiolytic,
        onsetMinutes: 15,
        tmaxMinutes: 75,
    ...
    public static let lorazepam = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Lorazepam", fr: "Lorazépam", es: "Lorazepam", ja: "ロラゼパム", zh: "劳拉西泮", ko: "로라제팜", ru: "Лоразепам", de: "Lorazepam", ar: "لورازيبام"),
        therapeuticClass: .anxiolytic,
        onsetMinutes: 20,
        tmaxMinutes: 120,
        halfLifeMinutes: 720,
    ...
    public static let clonazepam = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Clonazepam", fr: "Clonazépam", es: "Clonazepam", ja: "クロナゼパム", zh: "氯硝西泮", ko: "클로나제팜", ru: "Клоназепам", de: "Clonazepam", ar: "كلونازيبام"),
        therapeuticClass: .anxiolytic,
        onsetMinutes: 20,
        tmaxMinutes: 150,
    ...
    public static let buspirone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Buspirone", fr: "Buspirone", es: "Buspirona", ja: "ブスピロン", zh: "丁螺环酮", ko: "부스피론", ru: "Буспирон", de: "Buspiron", ar: "بوسبيرون"),
        therapeuticClass: .anxiolytic,
        onsetMinutes: 30,
        tmaxMinutes: 60,
        halfLifeMinutes: 150,
    ...
    public static let hydroxyzine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Hydroxyzine", fr: "Hydroxyzine", es: "Hidroxizina", ja: "ヒドロキシジン", zh: "羟嗪", ko: "하이드록시진", ru: "Гидроксизин", de: "Hydroxyzin", ar: "هيدروكسيزين"),
    ...
    public static let zolpidem = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Zolpidem", fr: "Zolpidem", es: "Zolpidem", ja: "ゾルピデム", zh: "唑吡坦", ko: "졸피뎀", ru: "Золпидем", de: "Zolpidem", ar: "زولبيديم"),
    ...
    public static let suvorexant = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Suvorexant", fr: "Suvorexant", es: "Suvorexant", ja: "スボレキサント", zh: "苏沃雷生", ko: "수보렉산트", ru: "Суворексант", de: "Suvorexant", ar: "سوفوريكسانت"),
        therapeuticClass: .sedativeHypnotic,
        onsetMinutes: 30,
        tmaxMinutes: 120,
        halfLifeMinutes: 720,
...
extension PharmacokineticProfile {
    ...
    public static let oxycodone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Oxycodone", fr: "Oxycodone", es: "Oxicodona", ja: "オキシコドン", zh: "羟考酮", ko: "옥시코돈", ru: "Оксикодон", de: "Oxycodon", ar: "أوكسيكودون"),
        therapeuticClass: .opioidAnalgesic,
        onsetMinutes: 15,
        tmaxMinutes: 90,
        halfLifeMinutes: 210,
    ...
    public static let hydrocodone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Hydrocodone", fr: "Hydrocodone", es: "Hidrocodona", ja: "ヒドロコドン", zh: "氢可酮", ko: "하이드로코돈", ru: "Гидрокодон", de: "Hydrocodon", ar: "هيدروكودون"),
        therapeuticClass: .opioidAnalgesic,
        onsetMinutes: 20,
        tmaxMinutes: 78,
        halfLifeMinutes: 240,
    ...
    public static let fentanyl = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Fentanyl", fr: "Fentanyl", es: "Fentanilo", ja: "フェンタニル", zh: "芬太尼", ko: "펜타닐", ru: "Фентанил", de: "Fentanyl", ar: "فينتانيل"),
        therapeuticClass: .opioidAnalgesic,
        onsetMinutes: 5,
        tmaxMinutes: 25,
        halfLifeMinutes: 420,
    ...
    public static let methadone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Methadone", fr: "Méthadone", es: "Metadona", ja: "メサドン", zh: "美沙酮", ko: "메사돈", ru: "Метадон", de: "Methadon", ar: "ميثادون"),
        therapeuticClass: .opioidAnalgesic,
        onsetMinutes: 30,
        tmaxMinutes: 195,
        halfLifeMinutes: 1800,
    ...
    public static let buprenorphine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Buprenorphine", fr: "Buprénorphine", es: "Buprenorfina", ja: "ブプレノルフィン", zh: "丁丙诺啡", ko: "부프레노르핀", ru: "Бупренорфин", de: "Buprenorphin", ar: "بوبرينورفين"),
        therapeuticClass: .opioidAnalgesic,
        onsetMinutes: 30,
        tmaxMinutes: 60,
    ...
    public static let tramadol = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Tramadol", fr: "Tramadol", es: "Tramadol", ja: "トラマドール", zh: "曲马多", ko: "트라마돌", ru: "Трамадол", de: "Tramadol", ar: "ترامادول"),
        therapeuticClass: .opioidAnalgesic,
        onsetMinutes: 30,
        tmaxMinutes: 120,
        halfLifeMinutes: 360,
    ...
    public static let naltrexone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Naltrexone", fr: "Naltrexone", es: "Naltrexona", ja: "ナルトレキソン", zh: "纳曲酮", ko: "날트렉손", ru: "Налтрексон", de: "Naltrexon", ar: "نالتريكسون"),
        therapeuticClass: .opioidAnalgesic,
        onsetMinutes: 15,
        tmaxMinutes: 60,
        halfLifeMinutes: 240,
...
extension PharmacokineticProfile {
    ...
    public static let gabapentin = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Gabapentin", fr: "Gabapentine", es: "Gabapentina", ja: "ガバペンチン", zh: "加巴喷丁", ko: "가바펜틴", ru: "Габапентин", de: "Gabapentin", ar: "غابابنتين"),
    ...
    public static let pregabalin = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Pregabalin", fr: "Prégabaline", es: "Pregabalina", ja: "プレガバリン", zh: "普瑞巴林", ko: "프레가발린", ru: "Прегабалин", de: "Pregabalin", ar: "بريغابالين"),
        therapeuticClass: .anticonvulsant,
        onsetMinutes: 30,
        tmaxMinutes: 90,
        halfLifeMinutes: 360,
    ...
    public static let lamotrigine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Lamotrigine", fr: "Lamotrigine", es: "Lamotrigina", ja: "ラモトリギン", zh: "拉莫三嗪", ko: "라모트리진", ru: "Ламотриджин", de: "Lamotrigin", ar: "لاموتريجين"),
        therapeuticClass: .anticonvulsant,
        onsetMinutes: 60,
        tmaxMinutes: 150,
        halfLifeMinutes: 1500,
    ...
    public static let valproate = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Valproate", fr: "Valproate", es: "Valproato", ja: "バルプロ酸", zh: "丙戊酸", ko: "발프로산", ru: "Вальпроат", de: "Valproat", ar: "فالبروات"),
        therapeuticClass: .anticonvulsant,
        onsetMinutes: 60,
        tmaxMinutes: 240,
        halfLifeMinutes: 750,
    ...
    public static let lithium = PharmacokineticProfile(
        substanceId: "lithium",
        name: LocalizedString(en: "Lithium", fr: "Lithium", es: "Litio", ja: "リチウム", zh: "锂", ko: "리튬", ru: "Литий", de: "Lithium", ar: "ليثيوم"),
        therapeuticClass: .anticonvulsant,
        onsetMinutes: 60,
        tmaxMinutes: 180,
    ...
    public static let carbamazepine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Carbamazepine", fr: "Carbamazépine", es: "Carbamazepina", ja: "カルバマゼピン", zh: "卡马西平", ko: "카르바마제핀", ru: "Карбамазепин", de: "Carbamazepin", ar: "كاربامازيبين"),
        therapeuticClass: .anticonvulsant,
        onsetMinutes: 60,
        tmaxMinutes: 270,
        halfLifeMinutes: 870,
    ...
    public static let topiramate = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Topiramate", fr: "Topiramate", es: "Topiramato", ja: "トピラマート", zh: "托吡酯", ko: "토피라메이트", ru: "Топирамат", de: "Topiramat", ar: "توبيراميت"),
        therapeuticClass: .anticonvulsant,
        onsetMinutes: 60,
        tmaxMinutes: 120,
        halfLifeMinutes: 1260,
...
extension PharmacokineticProfile {
    ...
    public static let ethanol = PharmacokineticProfile(
        substanceId: "ethanol",
        name: LocalizedString(en: "Alcohol (Ethanol)", fr: "Alcool (Éthanol)", es: "Alcohol (Etanol)", ja: "アルコール（エタノール）", zh: "酒精（乙醇）", ko: "알코올 (에탄올)", ru: "Алкоголь (этанол)", de: "Alkohol (Ethanol)", ar: "كحول (إيثانول)"),
    ...
    public static let thc = PharmacokineticProfile(
        substanceId: "thc",
        name: LocalizedString(en: "THC (Cannabis)", fr: "THC (Cannabis)", es: "THC (Cannabis)", ja: "THC（大麻）", zh: "THC（大麻）", ko: "THC (대마)", ru: "ТГК (каннабис)", de: "THC (Cannabis)", ar: "THC (قنب)"),
    ...
    public static let cocaine = PharmacokineticProfile(
        substanceId: "cocaine",
        name: LocalizedString(en: "Cocaine", fr: "Cocaïne", es: "Cocaína", ja: "コカイン", zh: "可卡因", ko: "코카인", ru: "Кокаин", de: "Kokain", ar: "كوكايين"),
        therapeuticClass: .stimulant,
        onsetMinutes: 3,
        tmaxMinutes: 30,
        halfLifeMinutes: 60,
    ...
    public static let mdma = PharmacokineticProfile(
        substanceId: "mdma",
        name: LocalizedString(en: "MDMA", fr: "MDMA", es: "MDMA", ja: "MDMA", zh: "MDMA", ko: "MDMA", ru: "МДМА", de: "MDMA", ar: "MDMA"),
        therapeuticClass: .stimulant,
        onsetMinutes: 30,
        tmaxMinutes: 120,
        halfLifeMinutes: 480,
    ...
    public static let lsd = PharmacokineticProfile(
        substanceId: "lsd",
        name: LocalizedString(en: "LSD", fr: "LSD", es: "LSD", ja: "LSD", zh: "LSD", ko: "LSD", ru: "ЛСД", de: "LSD", ar: "LSD"),
        therapeuticClass: .psychedelic,
        onsetMinutes: 30,
        tmaxMinutes: 120,
        halfLifeMinutes: 210,
    ...
    public static let ketamine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Ketamine", fr: "Kétamine", es: "Ketamina", ja: "ケタミン", zh: "氯胺酮", ko: "케타민", ru: "Кетамин", de: "Ketamin", ar: "كيتامين"),
    ...
    public static let ghb = PharmacokineticProfile(
        substanceId: "ghb",
        name: LocalizedString(en: "GHB (Sodium Oxybate)", fr: "GHB (Oxybate de sodium)", es: "GHB (Oxibato de sodio)", ja: "GHB（オキシバ酸ナトリウム）", zh: "GHB（羟丁酸钠）", ko: "GHB (옥시베이트나트륨)", ru: "ГОМК (оксибутират натрия)", de: "GHB (Natriumoxybat)", ar: "GHB (أوكسيبات الصوديوم)"),
        therapeuticClass: .sedativeHypnotic,
        onsetMinutes: 15,
        tmaxMinutes: 35,
        halfLifeMinutes: 45,
...
extension PharmacokineticProfile {
    ...
    public static let diphenhydramine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Diphenhydramine", fr: "Diphenhydramine", es: "Difenhidramina", ja: "ジフェンヒドラミン", zh: "苯海拉明", ko: "디펜히드라민", ru: "Дифенгидрамин", de: "Diphenhydramin", ar: "ديفينهيدرامين"),
        therapeuticClass: .antihistamine,
        onsetMinutes: 30,
        tmaxMinutes: 120,
        halfLifeMinutes: 360,
    ...
    public static let promethazine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Promethazine", fr: "Prométhazine", es: "Prometazina", ja: "プロメタジン", zh: "异丙嗪", ko: "프로메타진", ru: "Прометазин", de: "Promethazin", ar: "بروميثازين"),
        therapeuticClass: .antihistamine,
        onsetMinutes: 30,
        tmaxMinutes: 150,
        halfLifeMinutes: 720,
...
extension PharmacokineticProfile {
    ...
    public static let ibuprofen = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Ibuprofen", fr: "Ibuprofène", es: "Ibuprofeno", ja: "イブプロフェン", zh: "布洛芬", ko: "이부프로펜", ru: "Ибупрофен", de: "Ibuprofen", ar: "إيبوبروفين"),
    ...
    public static let prednisone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Prednisone", fr: "Prednisone", es: "Prednisona", ja: "プレドニゾン", zh: "泼尼松", ko: "프레드니손", ru: "Преднизон", de: "Prednison", ar: "بريدنيزون"),
    ...
    public static let dexamethasone = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Dexamethasone", fr: "Dexaméthasone", es: "Dexametasona", ja: "デキサメタゾン", zh: "地塞米松", ko: "덱사메타손", ru: "Дексаметазон", de: "Dexamethason", ar: "ديكساميثازون"),
        therapeuticClass: .corticosteroid,
        onsetMinutes: 60,
        tmaxMinutes: 120,
...
extension PharmacokineticProfile {
    ...
    public static let metoclopramide = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Metoclopramide", fr: "Métoclopramide", es: "Metoclopramida", ja: "メトクロプラミド", zh: "甲氧氯普胺", ko: "메토클로프라미드", ru: "Метоклопрамид", de: "Metoclopramid", ar: "ميتوكلوبراميد"),
    ...
    public static let levothyroxine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Levothyroxine", fr: "Lévothyroxine", es: "Levotiroxina", ja: "レボチロキシン", zh: "左甲状腺素", ko: "레보티록신", ru: "Левотироксин", de: "Levothyroxin", ar: "ليفوثيروكسين"),
    ...
    public static let insulinRapid = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Insulin (Rapid)", fr: "Insuline (rapide)", es: "Insulina (rápida)", ja: "インスリン（速効型）", zh: "胰岛素（速效）", ko: "인슐린 (속효성)", ru: "Инсулин (быстрого действия)", de: "Insulin (schnellwirkend)", ar: "إنسولين (سريع المفعول)"),
        therapeuticClass: .endocrine,
        onsetMinutes: 15,
        tmaxMinutes: 60,
        halfLifeMinutes: 60,
...
extension PharmacokineticProfile {
    ...
    public static let cyclobenzaprine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Cyclobenzaprine", fr: "Cyclobenzaprine", es: "Ciclobenzaprina", ja: "シクロベンザプリン", zh: "环苯扎林", ko: "시클로벤자프린", ru: "Циклобензаприн", de: "Cyclobenzaprin", ar: "سيكلوبنزابرين"),
        therapeuticClass: .other,
        onsetMinutes: 60,
        tmaxMinutes: 330,
    ...
    public static let baclofen = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Baclofen", fr: "Baclofène", es: "Baclofeno", ja: "バクロフェン", zh: "巴氯芬", ko: "바클로펜", ru: "Баклофен", de: "Baclofen", ar: "باكلوفين"),
        therapeuticClass: .other,
        onsetMinutes: 30,
        tmaxMinutes: 150,
        halfLifeMinutes: 210,
    ...
    public static let tizanidine = PharmacokineticProfile(
        ...
        name: LocalizedString(en: "Tizanidine", fr: "Tizanidine", es: "Tizanidina", ja: "チザニジン", zh: "替扎尼定", ko: "티자니딘", ru: "Тизанидин", de: "Tizanidin", ar: "تيزانيدين"),
        therapeuticClass: .other,
        onsetMinutes: 30,
        tmaxMinutes: 60,
        halfLifeMinutes: 150,
