...
extension MolecularDescriptor {
    ...
    public static let knownDescriptors: [MolecularDescriptor] = [
        ...
        MolecularDescriptor(substanceId: "lisdexamfetamine", molecularWeightDa: 263.4, heavyAtomCount: 19, cLogP: 0.58, hBondDonors: 3, hBondAcceptors: 4, polarSurfaceArea: 75.3, rotatableBondCount: 4),
        ...
        MolecularDescriptor(substanceId: "atomoxetine", molecularWeightDa: 255.4, heavyAtomCount: 19, cLogP: 3.51, hBondDonors: 1, hBondAcceptors: 2, polarSurfaceArea: 21.3, rotatableBondCount: 4),
        ...
        MolecularDescriptor(substanceId: "propranolol", molecularWeightDa: 259.3, heavyAtomCount: 19, cLogP: 3.48, hBondDonors: 2, hBondAcceptors: 3, polarSurfaceArea: 41.5, rotatableBondCount: 5),
        MolecularDescriptor(substanceId: "metoprolol", molecularWeightDa: 267.4, heavyAtomCount: 19, cLogP: 1.88, hBondDonors: 2, hBondAcceptors: 4, polarSurfaceArea: 50.7, rotatableBondCount: 7),
        MolecularDescriptor(substanceId: "atenolol", molecularWeightDa: 266.3, heavyAtomCount: 19, cLogP: 0.16, hBondDonors: 3, hBondAcceptors: 4, polarSurfaceArea: 84.6, rotatableBondCount: 6),
        MolecularDescriptor(substanceId: "bisoprolol", molecularWeightDa: 325.4, heavyAtomCount: 23, cLogP: 1.87, hBondDonors: 2, hBondAcceptors: 5, polarSurfaceArea: 60.0, rotatableBondCount: 7),
        MolecularDescriptor(substanceId: "carvedilol", molecularWeightDa: 406.5, heavyAtomCount: 30, cLogP: 4.19, hBondDonors: 2, hBondAcceptors: 5, polarSurfaceArea: 75.7, rotatableBondCount: 6),
        ...
        MolecularDescriptor(substanceId: "guanfacine", molecularWeightDa: 246.1, heavyAtomCount: 16, cLogP: 1.52, hBondDonors: 2, hBondAcceptors: 2, polarSurfaceArea: 58.3, rotatableBondCount: 2),
        MolecularDescriptor(substanceId: "digoxin", molecularWeightDa: 780.9, heavyAtomCount: 54, cLogP: 1.26, hBondDonors: 5, hBondAcceptors: 14, polarSurfaceArea: 203.1, rotatableBondCount: 8),
        MolecularDescriptor(substanceId: "ivabradine", molecularWeightDa: 468.6, heavyAtomCount: 34, cLogP: 2.96, hBondDonors: 0, hBondAcceptors: 5, polarSurfaceArea: 60.8, rotatableBondCount: 5),

        // ── SSRIs / Antidepressants ──
        MolecularDescriptor(substanceId: "sertraline", molecularWeightDa: 306.2, heavyAtomCount: 20, cLogP: 5.29, hBondDonors: 1, hBondAcceptors: 1, polarSurfaceArea: 12.0, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "fluoxetine", molecularWeightDa: 309.3, heavyAtomCount: 22, cLogP: 4.05, hBondDonors: 1, hBondAcceptors: 2, polarSurfaceArea: 21.3, rotatableBondCount: 5),
        MolecularDescriptor(substanceId: "escitalopram", molecularWeightDa: 324.4, heavyAtomCount: 24, cLogP: 3.50, hBondDonors: 1, hBondAcceptors: 3, polarSurfaceArea: 36.3, rotatableBondCount: 4),
        MolecularDescriptor(substanceId: "paroxetine", molecularWeightDa: 329.4, heavyAtomCount: 23, cLogP: 3.60, hBondDonors: 1, hBondAcceptors: 4, polarSurfaceArea: 39.7, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "venlafaxine", molecularWeightDa: 277.4, heavyAtomCount: 20, cLogP: 3.20, hBondDonors: 1, hBondAcceptors: 3, polarSurfaceArea: 32.7, rotatableBondCount: 6),
        MolecularDescriptor(substanceId: "duloxetine", molecularWeightDa: 297.4, heavyAtomCount: 22, cLogP: 4.21, hBondDonors: 1, hBondAcceptors: 3, polarSurfaceArea: 21.3, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "bupropion", molecularWeightDa: 239.7, heavyAtomCount: 16, cLogP: 3.21, hBondDonors: 1, hBondAcceptors: 2, polarSurfaceArea: 29.1, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "mirtazapine", molecularWeightDa: 265.4, heavyAtomCount: 20, cLogP: 2.90, hBondDonors: 0, hBondAcceptors: 3, polarSurfaceArea: 19.4, rotatableBondCount: 1),
        MolecularDescriptor(substanceId: "trazodone", molecularWeightDa: 371.9, heavyAtomCount: 26, cLogP: 2.68, hBondDonors: 0, hBondAcceptors: 5, polarSurfaceArea: 42.4, rotatableBondCount: 4),
        MolecularDescriptor(substanceId: "amitriptyline", molecularWeightDa: 277.4, heavyAtomCount: 21, cLogP: 4.92, hBondDonors: 0, hBondAcceptors: 1, polarSurfaceArea: 3.2, rotatableBondCount: 3),
        ...
        MolecularDescriptor(substanceId: "phenelzine", molecularWeightDa: 136.2, heavyAtomCount: 10, cLogP: 0.91, hBondDonors: 2, hBondAcceptors: 2, polarSurfaceArea: 38.1, rotatableBondCount: 2),
        MolecularDescriptor(substanceId: "tranylcypromine", molecularWeightDa: 133.2, heavyAtomCount: 10, cLogP: 1.42, hBondDonors: 1, hBondAcceptors: 1, polarSurfaceArea: 26.0, rotatableBondCount: 0),

        // ── Antipsychotics ──
        MolecularDescriptor(substanceId: "quetiapine", molecularWeightDa: 383.5, heavyAtomCount: 27, cLogP: 2.81, hBondDonors: 1, hBondAcceptors: 4, polarSurfaceArea: 48.8, rotatableBondCount: 7),
        MolecularDescriptor(substanceId: "olanzapine", molecularWeightDa: 312.4, heavyAtomCount: 23, cLogP: 2.10, hBondDonors: 1, hBondAcceptors: 4, polarSurfaceArea: 30.9, rotatableBondCount: 2),
        ...
        MolecularDescriptor(substanceId: "aripiprazole", molecularWeightDa: 448.4, heavyAtomCount: 31, cLogP: 4.49, hBondDonors: 1, hBondAcceptors: 4, polarSurfaceArea: 44.8, rotatableBondCount: 6),
        ...
        MolecularDescriptor(substanceId: "chlorpromazine", molecularWeightDa: 318.9, heavyAtomCount: 21, cLogP: 5.18, hBondDonors: 0, hBondAcceptors: 2, polarSurfaceArea: 6.5, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "clozapine", molecularWeightDa: 326.8, heavyAtomCount: 23, cLogP: 3.23, hBondDonors: 1, hBondAcceptors: 4, polarSurfaceArea: 30.9, rotatableBondCount: 2),

        // ── Anxiolytics / Sedatives ──
        MolecularDescriptor(substanceId: "alprazolam", molecularWeightDa: 308.8, heavyAtomCount: 22, cLogP: 2.12, hBondDonors: 0, hBondAcceptors: 3, polarSurfaceArea: 43.1, rotatableBondCount: 0),
        ...
        MolecularDescriptor(substanceId: "lorazepam", molecularWeightDa: 321.2, heavyAtomCount: 22, cLogP: 2.39, hBondDonors: 2, hBondAcceptors: 3, polarSurfaceArea: 61.7, rotatableBondCount: 0),
        MolecularDescriptor(substanceId: "clonazepam", molecularWeightDa: 315.7, heavyAtomCount: 23, cLogP: 2.41, hBondDonors: 1, hBondAcceptors: 4, polarSurfaceArea: 87.0, rotatableBondCount: 0),
        MolecularDescriptor(substanceId: "buspirone", molecularWeightDa: 385.5, heavyAtomCount: 28, cLogP: 2.67, hBondDonors: 0, hBondAcceptors: 5, polarSurfaceArea: 69.6, rotatableBondCount: 5),
        MolecularDescriptor(substanceId: "hydroxyzine", molecularWeightDa: 374.9, heavyAtomCount: 26, cLogP: 2.36, hBondDonors: 1, hBondAcceptors: 4, polarSurfaceArea: 35.9, rotatableBondCount: 5),
        MolecularDescriptor(substanceId: "zolpidem", molecularWeightDa: 307.4, heavyAtomCount: 23, cLogP: 2.47, hBondDonors: 0, hBondAcceptors: 3, polarSurfaceArea: 37.6, rotatableBondCount: 2),
        MolecularDescriptor(substanceId: "suvorexant", molecularWeightDa: 450.9, heavyAtomCount: 31, cLogP: 3.61, hBondDonors: 0, hBondAcceptors: 5, polarSurfaceArea: 72.4, rotatableBondCount: 4),
        ...
        MolecularDescriptor(substanceId: "methadone", molecularWeightDa: 309.4, heavyAtomCount: 23, cLogP: 3.93, hBondDonors: 0, hBondAcceptors: 2, polarSurfaceArea: 20.3, rotatableBondCount: 5),
        MolecularDescriptor(substanceId: "buprenorphine", molecularWeightDa: 467.6, heavyAtomCount: 34, cLogP: 4.98, hBondDonors: 2, hBondAcceptors: 5, polarSurfaceArea: 62.2, rotatableBondCount: 2),
        MolecularDescriptor(substanceId: "tramadol", molecularWeightDa: 263.4, heavyAtomCount: 19, cLogP: 2.51, hBondDonors: 1, hBondAcceptors: 3, polarSurfaceArea: 32.7, rotatableBondCount: 3),
        ...
        MolecularDescriptor(substanceId: "pregabalin", molecularWeightDa: 159.2, heavyAtomCount: 11, cLogP: -1.35, hBondDonors: 2, hBondAcceptors: 3, polarSurfaceArea: 63.3, rotatableBondCount: 3),
        ...
        MolecularDescriptor(substanceId: "carbamazepine", molecularWeightDa: 236.3, heavyAtomCount: 18, cLogP: 2.45, hBondDonors: 1, hBondAcceptors: 2, polarSurfaceArea: 46.3, rotatableBondCount: 1),
        ...
        // ── Miscellaneous ──
        MolecularDescriptor(substanceId: "diphenhydramine", molecularWeightDa: 255.4, heavyAtomCount: 19, cLogP: 3.27, hBondDonors: 0, hBondAcceptors: 2, polarSurfaceArea: 12.5, rotatableBondCount: 4),
        ...
        MolecularDescriptor(substanceId: "ibuprofen", molecularWeightDa: 206.3, heavyAtomCount: 15, cLogP: 3.97, hBondDonors: 1, hBondAcceptors: 2, polarSurfaceArea: 37.3, rotatableBondCount: 3),
        ...
        MolecularDescriptor(substanceId: "dexamethasone", molecularWeightDa: 392.5, heavyAtomCount: 28, cLogP: 1.83, hBondDonors: 3, hBondAcceptors: 5, polarSurfaceArea: 94.8, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "metoclopramide", molecularWeightDa: 299.8, heavyAtomCount: 21, cLogP: 2.62, hBondDonors: 2, hBondAcceptors: 4, polarSurfaceArea: 67.6, rotatableBondCount: 4),
        MolecularDescriptor(substanceId: "levothyroxine", molecularWeightDa: 776.9, heavyAtomCount: 33, cLogP: 2.43, hBondDonors: 3, hBondAcceptors: 4, polarSurfaceArea: 96.8, rotatableBondCount: 4),
        ...
        MolecularDescriptor(substanceId: "baclofen", molecularWeightDa: 213.7, heavyAtomCount: 14, cLogP: 1.27, hBondDonors: 2, hBondAcceptors: 3, polarSurfaceArea: 63.3, rotatableBondCount: 2),
        ...
        // ── Missing PokeDrug Expansion Species ──
        MolecularDescriptor(substanceId: "psilocin", molecularWeightDa: 204.3, heavyAtomCount: 15, cLogP: 1.42, hBondDonors: 2, hBondAcceptors: 3, polarSurfaceArea: 39.3, rotatableBondCount: 2),
        MolecularDescriptor(substanceId: "mda", molecularWeightDa: 179.2, heavyAtomCount: 13, cLogP: 1.67, hBondDonors: 1, hBondAcceptors: 3, polarSurfaceArea: 30.5, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "muscimol", molecularWeightDa: 114.1, heavyAtomCount: 8, cLogP: -1.35, hBondDonors: 2, hBondAcceptors: 3, polarSurfaceArea: 57.3, rotatableBondCount: 1),
        MolecularDescriptor(substanceId: "ephedrine", molecularWeightDa: 165.2, heavyAtomCount: 12, cLogP: 0.87, hBondDonors: 2, hBondAcceptors: 2, polarSurfaceArea: 48.5, rotatableBondCount: 3),
        MolecularDescriptor(substanceId: "mitragynine", molecularWeightDa: 398.5, heavyAtomCount: 29, cLogP: 2.91, hBondDonors: 1, hBondAcceptors: 5, polarSurfaceArea: 57.6, rotatableBondCount: 5),
        MolecularDescriptor(substanceId: "cbd", molecularWeightDa: 314.5, heavyAtomCount: 23, cLogP: 5.76, hBondDonors: 2, hBondAcceptors: 2, polarSurfaceArea: 40.5, rotatableBondCount: 6),
        MolecularDescriptor(substanceId: "harmine", molecularWeightDa: 212.3, heavyAtomCount: 16, cLogP: 2.75, hBondDonors: 1, hBondAcceptors: 3, polarSurfaceArea: 39.0, rotatableBondCount: 1),
    ]
}
